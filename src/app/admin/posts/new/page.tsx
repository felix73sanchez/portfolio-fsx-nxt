  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const data = await res.json();
        setError(data.error || 'Error al crear articulo');
      }
    } catch (_err) {
  ...
  return (
    ...
    >
      <p className="text-sm mb-6" style={{ color: 'var(--gray)' }}>
        Escribe en <strong>Markdown</strong> - Los headers, listas, codigo y mas se formatearan automaticamente
      </p>
...
Un parrafo normal con **texto en negrita** y *cursiva*.
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl p-5" style={{ background: 'var(--card-bg)', border: '1px solid var(--border)' }}>
              ...
              <label className="flex items-center gap-3 p-3 rounded-lg cursor-pointer transition"
                ...
                />
                <div>
                  <p className="font-medium text-sm">Publicar ahora</p>
                  <p className="text-xs" style={{ color: 'var(--gray)' }}>
                    {published ? 'Sera visible publicamente' : 'Se guardara como borrador'}
                  </p>
                </div>
              </label>
                ...
                >
                  {loading ? (
                    ...
                    <>
                      ...
                      {published ? 'Publicar articulo' : 'Guardar borrador'}
                    </>
                  )}
                </button>
              </div>
            ...
            <div className="rounded-xl p-5" style={{ background: 'var(--card-bg)', border: '1px solid var(--border)' }}>
              ...
              <div className="text-xs space-y-2" style={{ color: 'var(--gray)' }}>
                <p><code className="px-1 rounded" style={{ background: 'var(--light-gray)' }}>## Titulo</code> - Encabezado</p>
                ...
                <p><code className="px-1 rounded" style={{ background: 'var(--light-gray)' }}>`codigo`</code> - Codigo inline</p>
